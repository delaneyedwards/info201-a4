...
intro_panel <- tabPanel(
    ...
    mainPanel(
      fluidRow(column(width = 9, tags$p("CO2 emissions are a huge contributer to global warming and
      are mainly caused by burning oil, coal and gas, as well as mass
      deforestation. This is a huge problem that our society has yet to fix
      head on, however, important data has been collected about CO2 emissions
      across the globe. I chose to compare the Us to all of the
      Scandanavian countries, which you can see in the map on the right."),
              tags$p("When looking at this data, unsurprisingly the US
               ...
               column(width = 3, 
                      img(src = "https://i.pinimg.com/originals/6e/3c/d9/6e3cd966610c8563b26582db05836b72.jpg",
...
y_input <- selectInput(
  ...
  choices = c("Annual Production Based CO2 Emissions",
...
country_input <- checkboxGroupInput("country_input", "Select Countries to Look At",
                                    c("Norway",
                                    "Iceland",
                                    "Sweden",
                                    "Finland",
